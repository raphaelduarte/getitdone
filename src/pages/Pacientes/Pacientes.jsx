...
// Estilos inline para a maior parte do CSS
const cardStyle = {
  margin: '100px auto',
...
const Card = () => {
  return (
    <div style={cardStyle} className="e-card playing">
      <div style={waveStyle}></div>
      <div style={waveStyle}></div>
      <div style={waveStyle}></div>

      <div style={infoTopStyle}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" style={iconStyle}>
  ...
  19.8922 11.8742V14.7235C19.8922 15.2278 19.7589 15.7254 19.5119 16.1662C18.7615 15.3596 17.6806 14.8528
   ...
   20.3676C11.9347 20.5316 11.1396 20.4203 10.4684 20.0413H10.4676Z"></path>}
        ...
        UI / EX Designer
        <br />
        <div style={nameStyle}>MikeAndrewDesigner</div>
      </div>
    </div>
  );
};
